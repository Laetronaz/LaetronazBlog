    ...
    <tbody>
        <?php foreach($posts as $post) : ?> 
            <tr class="table-secondary">
                ...
                <td class="text-center align-middle" scope="row"><img class ="thumbnail" src="<?php echo site_url().POSTS_IMAGES_FOLDER.$post['post_image'];?>" height="50" width="50"></td>
                <td class="text-center align-middle" ><a href="<?php echo base_url().POSTS_VIEW_PATH.$post['slug']?>"><?php echo $post['title']?></a></td>
                ...
                <td class="text-center align-middle" scope="col">
                    <a class="btn btn-primary btn-block" href="<?php echo site_url().POSTS_EDIT_PATH.$post['slug']?>">
                        <i class="fas fa-edit"></i>
                    </a>
                </td>
                <td class="text-center align-middle" scope="col">
                    <?php if($post['state'] == TRUE) : ?>
                        <a class="btn btn-danger btn-block" href="<?php echo site_url().POSTS_TOGGLE_PATH.$post['id']?>">
                            <i class="fas fa-toggle-off" ></i>
                        </a>
                    <?php else : ?>
                        <a class="btn btn-success btn-block" href="<?php echo site_url().POSTS_TOGGLE_PATH.$post['id']?>">
                            <i class="fas fa-toggle-off" ></i>
                        </a>
                    <?php endif; ?>
                </td>
