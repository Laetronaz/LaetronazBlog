    ...
    <tbody>
        ...
        <?php foreach($users as $user) : ?>   
            <tr class="table-secondary">
                ...
                <td class="text-center" scope="row"><a href="<?php echo base_url().USERS_VIEW_PATH.$user['id']?>"><?php echo $user['username']?></a></td>
                ...
                <td class="text-center" scope="col">
                    <a class="btn btn-primary btn-block" href="<?php echo base_url().USERS_EDIT_PATH.$user['id'];?>">
                        <i class="fas fa-edit"></i>
                    </a>    
                </td>
                <td class="text-center" scope="col">
                       <?php if($user['user_state'] == 3) : ?>          
                            <a href="<?php echo base_url().USERS_TOGGLE_PATH.$user['id']?>" class="btn btn-danger btn-block">
