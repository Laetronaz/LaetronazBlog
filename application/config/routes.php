...
$route[POSTS_PAGINATION_INDEX_ROUTE] = POSTS_PAGINATION_INDEX_FUNC;
...
//Mail function links
$route[EMAIL_PASSWORD_RESET_ROUTE] = EMAIL_PASSWORD_RESET_FUNC;
...
$route[ABOUT_ROUTE] = ABOUT_FUNC;
$route['404_override'] = '';
$route['(:any)'] = POSTS_INDEX_PATH;
$route['translate_uri_dashes'] = FALSE;